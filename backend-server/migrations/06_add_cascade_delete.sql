...
-- Drop existing constraints (if any) safely using conditional drops
-- This avoids errors if constraints don't exist with these exact names
ALTER TABLE game_players
DROP FOREIGN KEY IF EXISTS FK_66d478167a4c11e2ad1ba74e52f,
DROP FOREIGN KEY IF EXISTS FK_9b399cb2228699b75fde3151d3d,
DROP FOREIGN KEY IF EXISTS FK_game_players_account,
DROP FOREIGN KEY IF EXISTS FK_game_players_game,
DROP FOREIGN KEY IF EXISTS FK_game_players_account_new,
DROP FOREIGN KEY IF EXISTS FK_game_players_game_new;
...
DROP FOREIGN KEY IF EXISTS FK_rating_history_account,
DROP FOREIGN KEY IF EXISTS FK_rating_history_game,
DROP FOREIGN KEY IF EXISTS FK_rating_history_account_new,
DROP FOREIGN KEY IF EXISTS FK_rating_history_game_new;

-- Same for player_ratings
ALTER TABLE player_ratings
DROP FOREIGN KEY IF EXISTS FK_1904b2d47778a44dcfabd28cc81,
DROP FOREIGN KEY IF EXISTS FK_player_ratings_account;
